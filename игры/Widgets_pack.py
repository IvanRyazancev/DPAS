...
class Window:
    ...
    def draw_widgets(self):
        ...
        Label(bottom_frame, width=30, height=2, bg="green", text="Third").pack(side=LEFT)
        Label(bottom_frame, width=30, height=2, bg="cyan", text="Fourth").pack(side=LEFT)
        Label(bottom_frame, width=30, height=2, bg="orange", text="Fifth").pack(side=LEFT)
