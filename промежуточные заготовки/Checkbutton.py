...
class Window:
    def __init__(self, width, height, title="MyWindow", resizable=(True, True), icon=r"ico_DPAS.ico"):
        ...
        self.parametrs = (("red", IntVar()), ("yellow", IntVar()), ("blue", IntVar()))
    ...
    def draw_widgets(self):
        ...
        # Checkbutton(self.root, text="SomeText",font=("Courier",10),justify=CENTER,underline=20).pack()
        ...
        for name, var in self.parametrs:
        ...
        Button(self.root, text="Save", width=10, command=self.show_parametrs).pack()
