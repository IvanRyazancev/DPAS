...
otmpch = float(input("Введите отметку проезжей части: "))
...
print(" ")
print("--------------------------=== Блок расчета параметров ростверка ===-------------------")
print(" ")
...
print("Общая масса балок пролетного строения: ", mbalki * nbalok, "т.")
