...
otmrig = float(input("Введите отметку верха ригеля: "))
nbalok1 = int(input("Введите количество балок в пролетном строении: "))
poperucl = float(input("Введите поперечный уклон: "))
shagbal = float(input("Введите шаг балок: "))
hpodfbaz = 0.15  # размер наименьшей подферменной площадки на опоре
otmpodfbaz = otmrig + 0.15  # отметка наименьшей подферменной площадки на опоре
nshag1 = 0
